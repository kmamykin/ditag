...
# ENV['RAILS_ENV'] ||= `hostname`.strip.ends_with?('bluehost.com') ? 'production' : 'development'
...
#ENV['TZ'] = ENV['RAILS_ENV'] == 'production' ? 'Mountain Time (US & Canada)' : 'Eastern Time (US & Canada)'
